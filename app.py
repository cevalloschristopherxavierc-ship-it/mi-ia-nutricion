                ...
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        if len(nums) >= 2:
                            ...
                            st.rerun()
                    else: st.error(f"⚠️ Error {r.status_code}. Revisa tu API Key en Secrets.")

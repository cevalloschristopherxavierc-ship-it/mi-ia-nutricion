...
if st.session_state.paso == 1:
    ...
    if f:
        ...
        with st.spinner("🤖 Jarvis analizando..."):
            try:
                # CORRECCIÓN AQUÍ: Usamos el nombre completo del modelo
                ...
                if len(res) >= 5:
                    ...
                    st.error("Respuesta inesperada de la IA. Intenta con otra foto.")
            except Exception as e:
                st.error(f"Error con el modelo de IA: {e}")
